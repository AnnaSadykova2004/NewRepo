...
{
    public class RightPerspectiveTransformer : ITransformer<RightPerspectiveParameters>
    {
        double narrowingFactor;
        Size oldSize;
        public Size ResultSize { get; private set; }

        public void Initialize(Size oldSize, RightPerspectiveParameters parameters)
        {
